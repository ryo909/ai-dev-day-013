import './style.css';
const PROFILE = {"day":"Day013","title":"Meal Prep Slotter","one_sentence":"平日の食事準備を短時間で回すための作り置き計画ツール。（話題:HN Frontpage）","core_action":"plan","family":"meal_batching","mechanic":"process_ordering","input_style":"ingredient_list","output_style":"prep_timeline","audience_promise":"lower_daily_friction","publish_hook":"平日の料理負担を先に潰す","engine":"agenda_builder"};
