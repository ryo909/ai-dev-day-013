import './style.css';
const PROFILE = {"day":"Day013","title":"Slot Checklist Planner","one_sentence":"時間枠とチェックリストを一体化した実行計画プランナー。（話題:HN Frontpage）","core_action":"plan","family":"slot_planning","mechanic":"slot_assignment_with_check","input_style":"task_cards","output_style":"checklist_timeline","audience_promise":"better_execution_consistency","publish_hook":"未完了を次枠へ自動繰越","engine":"slot_planner","interaction_archetype":"checklist_slot_planner","page_archetype":"timeline_planner","output_shape":"slot_checklist","state_model":"slots_with_completion_flags","core_loop":"assign -> check -> carry","component_pack":"slot_grid+checklist_panel","scaffold_id":"slot_checklist_planner","single_shot_text_generator":false};
